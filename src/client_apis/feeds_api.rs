...
impl SpapiClient {
    ...
    pub async fn cancel_feed(&self, feed_id: &str) -> Result<()> {
        ...
        self.limiter()
            .wait_for_token("/feeds/2021-06-30/feeds", 0.016, 15)
            .await?;
        let res = apis::feeds_api::cancel_feed(&configuration, feed_id).await;
        self.limiter()
            .record_response("/feeds/2021-06-30/feeds")
            .await?;
        Ok(res?)
    }
    ...
    pub async fn create_feed(
        ...
        let configuration = self.create_configuration().await?;
        self.limiter()
            .wait_for_token("/feeds/2021-06-30/feeds", 0.0083, 15)
            .await?;
    ...
    pub async fn create_feed_document(
        ...
        let configuration = self.create_configuration().await?;
        self.limiter()
            .wait_for_token("/feeds/2021-06-30/documents", 0.5, 15)
            .await?;
        let res = apis::feeds_api::create_feed_document(&configuration, body).await;
        self.limiter()
            .record_response("/feeds/2021-06-30/documents")
            .await?;
        Ok(res?)
    }
    ...
    pub async fn get_feed(&self, feed_id: &str) -> Result<models::feeds_2021_06_30::Feed> {
        let configuration = self.create_configuration().await?;
        self.limiter()
            .wait_for_token("/feeds/2021-06-30/feeds", 2.0, 15)
            .await?;
    ...
    pub async fn get_feed_document(
        ...
        let configuration = self.create_configuration().await?;
        self.limiter()
            .wait_for_token("/feeds/2021-06-30/documents", 0.0222, 10)
            .await?;
    ...
    pub async fn get_feeds(
        ...
        let configuration = self.create_configuration().await?;
        self.limiter()
            .wait_for_token("/feeds/2021-06-30/feeds", 0.0222, 10)
            .await?;

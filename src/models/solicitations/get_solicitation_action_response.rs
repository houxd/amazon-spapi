...
pub struct GetSolicitationActionResponse {
    ...
    pub _links: Option<Box<models::solicitations::GetSolicitationActionResponseLinks>>,
    #[serde(rename = "_embedded", skip_serializing_if = "Option::is_none")]
    pub _embedded: Option<Box<models::solicitations::GetSolicitationActionResponseEmbedded>>,
    #[serde(rename = "payload", skip_serializing_if = "Option::is_none")]
    pub payload: Option<Box<models::solicitations::SolicitationsAction>>,
    /// A list of error responses returned when a request is unsuccessful.
    #[serde(rename = "errors", skip_serializing_if = "Option::is_none")]
    pub errors: Option<Vec<models::solicitations::Error>>,
}

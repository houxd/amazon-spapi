...
pub struct GetSolicitationActionsForOrderResponse {
    ...
    pub _links: Option<Box<models::solicitations::GetSolicitationActionsForOrderResponseLinks>>,
    #[serde(rename = "_embedded", skip_serializing_if = "Option::is_none")]
    pub _embedded: Option<Box<models::solicitations::GetSolicitationActionsForOrderResponseEmbedded>>,

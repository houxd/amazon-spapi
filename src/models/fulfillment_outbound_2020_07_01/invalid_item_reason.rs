...
pub struct InvalidItemReason {
    ...
    pub invalid_item_reason_code: models::fulfillment_outbound_2020_07_01::InvalidItemReasonCode,
...
impl InvalidItemReason {
    ...
    pub fn new(invalid_item_reason_code: models::fulfillment_outbound_2020_07_01::InvalidItemReasonCode, description: String) -> InvalidItemReason {
        InvalidItemReason {

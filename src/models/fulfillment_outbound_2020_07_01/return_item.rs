...
pub struct ReturnItem {
    ...
    #[serde(rename = "status")]
    pub status: models::fulfillment_outbound_2020_07_01::FulfillmentReturnItemStatus,
    /// Date timestamp
    ...
    pub return_received_condition: Option<models::fulfillment_outbound_2020_07_01::ReturnItemDisposition>,
...
impl ReturnItem {
    ...
    pub fn new(seller_return_item_id: String, seller_fulfillment_order_item_id: String, amazon_shipment_id: String, seller_return_reason_code: String, status: models::fulfillment_outbound_2020_07_01::FulfillmentReturnItemStatus, status_changed_date: String) -> ReturnItem {
        ReturnItem {

...
pub struct ReturnAuthorization {
    ...
    pub return_to_address: Box<models::fulfillment_outbound_2020_07_01::Address>,
...
impl ReturnAuthorization {
    ...
    pub fn new(return_authorization_id: String, fulfillment_center_id: String, return_to_address: models::fulfillment_outbound_2020_07_01::Address, amazon_rma_id: String, rma_page_url: String) -> ReturnAuthorization {
        ReturnAuthorization {

...
pub struct UpdateFulfillmentOrderRequest {
    ...
    pub shipping_speed_category: Option<models::fulfillment_outbound_2020_07_01::ShippingSpeedCategory>,
    #[serde(rename = "destinationAddress", skip_serializing_if = "Option::is_none")]
    pub destination_address: Option<Box<models::fulfillment_outbound_2020_07_01::Address>>,
    ...
    pub items: Option<Vec<models::fulfillment_outbound_2020_07_01::UpdateFulfillmentOrderItem>>,
}

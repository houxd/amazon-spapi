...
pub struct InvalidReturnItem {
    ...
    pub invalid_item_reason: Box<models::fulfillment_outbound_2020_07_01::InvalidItemReason>,
}

impl InvalidReturnItem {
    /// An item that is invalid for return.
    pub fn new(seller_return_item_id: String, seller_fulfillment_order_item_id: String, invalid_item_reason: models::fulfillment_outbound_2020_07_01::InvalidItemReason) -> InvalidReturnItem {
        InvalidReturnItem {

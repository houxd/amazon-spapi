...
pub struct FulfillmentOrderItem {
    ...
    pub per_unit_price: Option<Box<models::fulfillment_outbound_2020_07_01::Money>>,
    #[serde(rename = "perUnitTax", skip_serializing_if = "Option::is_none")]
    pub per_unit_tax: Option<Box<models::fulfillment_outbound_2020_07_01::Money>>,
    #[serde(rename = "perUnitDeclaredValue", skip_serializing_if = "Option::is_none")]
    pub per_unit_declared_value: Option<Box<models::fulfillment_outbound_2020_07_01::Money>>,
}

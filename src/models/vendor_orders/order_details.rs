...
pub struct OrderDetails {
    ...
    pub import_details: Option<Box<models::vendor_orders::ImportDetails>>,
    ...
    pub buying_party: Option<Box<models::vendor_orders::PartyIdentification>>,
    #[serde(rename = "sellingParty", skip_serializing_if = "Option::is_none")]
    pub selling_party: Option<Box<models::vendor_orders::PartyIdentification>>,
    #[serde(rename = "shipToParty", skip_serializing_if = "Option::is_none")]
    pub ship_to_party: Option<Box<models::vendor_orders::PartyIdentification>>,
    #[serde(rename = "billToParty", skip_serializing_if = "Option::is_none")]
    pub bill_to_party: Option<Box<models::vendor_orders::PartyIdentification>>,
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::vendor_orders::OrderItem>,
}

impl OrderDetails {
    /// Details of an order.
    pub fn new(purchase_order_date: String, purchase_order_state_changed_date: String, items: Vec<models::vendor_orders::OrderItem>) -> OrderDetails {
        OrderDetails {
            purchase_order_date,

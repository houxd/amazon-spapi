...
pub struct OrderStatus {
    ...
    pub ship_to_party: Box<models::vendor_orders::PartyIdentification>,
    /// Detailed description of items order status.
    #[serde(rename = "itemStatus")]
    pub item_status: Vec<models::vendor_orders::OrderItemStatus>,
}

impl OrderStatus {
    /// Current status of a purchase order.
    pub fn new(purchase_order_number: String, purchase_order_status: PurchaseOrderStatus, purchase_order_date: String, selling_party: models::vendor_orders::PartyIdentification, ship_to_party: models::vendor_orders::PartyIdentification, item_status: Vec<models::vendor_orders::OrderItemStatus>) -> OrderStatus {
        OrderStatus {

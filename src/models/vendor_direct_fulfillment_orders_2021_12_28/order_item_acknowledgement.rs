...
pub struct OrderItemAcknowledgement {
    ...
    pub acknowledged_quantity: Box<models::vendor_direct_fulfillment_orders_2021_12_28::ItemQuantity>,
}

impl OrderItemAcknowledgement {
    /// Details of an individual item within the order being acknowledged.
    pub fn new(item_sequence_number: String, acknowledged_quantity: models::vendor_direct_fulfillment_orders_2021_12_28::ItemQuantity) -> OrderItemAcknowledgement {

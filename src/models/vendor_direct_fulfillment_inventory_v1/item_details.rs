...
pub struct ItemDetails {
    ...
    pub available_quantity: Box<models::vendor_direct_fulfillment_inventory_v1::ItemQuantity>,
...
impl ItemDetails {
    ...
    pub fn new(available_quantity: models::vendor_direct_fulfillment_inventory_v1::ItemQuantity) -> ItemDetails {
        ItemDetails {

...
pub struct Container {
    ...
    pub dimensions: Option<Box<models::vendor_direct_fulfillment_shipping_2021_12_28::Dimensions>>,
    #[serde(rename = "weight")]
    pub weight: Box<models::vendor_direct_fulfillment_shipping_2021_12_28::Weight>,
    /// A list of packed items.
    #[serde(rename = "packedItems")]
    pub packed_items: Vec<models::vendor_direct_fulfillment_shipping_2021_12_28::PackedItem>,
}

impl Container {
    /// A container used for shipping and packing items.
    pub fn new(container_type: ContainerType, container_identifier: String, weight: models::vendor_direct_fulfillment_shipping_2021_12_28::Weight, packed_items: Vec<models::vendor_direct_fulfillment_shipping_2021_12_28::PackedItem>) -> Container {
        Container {
            container_type,

...
pub struct PackedItem {
    ...
    pub packed_quantity: Box<models::vendor_direct_fulfillment_shipping_2021_12_28::ItemQuantity>,
}

impl PackedItem {
    /// An item that has been packed into a container for shipping.
    pub fn new(item_sequence_number: i32, packed_quantity: models::vendor_direct_fulfillment_shipping_2021_12_28::ItemQuantity) -> PackedItem {
        PackedItem {

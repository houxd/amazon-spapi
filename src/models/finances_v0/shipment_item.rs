...
pub struct ShipmentItem {
    ...
    pub item_charge_list: Option<Vec<models::finances_v0::ChargeComponent>>,
    /// A list of charge information on the seller's account.
    #[serde(rename = "ItemChargeAdjustmentList", skip_serializing_if = "Option::is_none")]
    pub item_charge_adjustment_list: Option<Vec<models::finances_v0::ChargeComponent>>,
    /// A list of fee component information.
    #[serde(rename = "ItemFeeList", skip_serializing_if = "Option::is_none")]
    pub item_fee_list: Option<Vec<models::finances_v0::FeeComponent>>,
    /// A list of fee component information.
    #[serde(rename = "ItemFeeAdjustmentList", skip_serializing_if = "Option::is_none")]
    pub item_fee_adjustment_list: Option<Vec<models::finances_v0::FeeComponent>>,
    /// A list of information about taxes withheld.
    #[serde(rename = "ItemTaxWithheldList", skip_serializing_if = "Option::is_none")]
    pub item_tax_withheld_list: Option<Vec<models::finances_v0::TaxWithheldComponent>>,
    /// A list of promotions.
    #[serde(rename = "PromotionList", skip_serializing_if = "Option::is_none")]
    pub promotion_list: Option<Vec<models::finances_v0::Promotion>>,
    /// A list of promotions.
    #[serde(rename = "PromotionAdjustmentList", skip_serializing_if = "Option::is_none")]
    pub promotion_adjustment_list: Option<Vec<models::finances_v0::Promotion>>,
    #[serde(rename = "CostOfPointsGranted", skip_serializing_if = "Option::is_none")]
    pub cost_of_points_granted: Option<Box<models::finances_v0::Currency>>,
    #[serde(rename = "CostOfPointsReturned", skip_serializing_if = "Option::is_none")]
    pub cost_of_points_returned: Option<Box<models::finances_v0::Currency>>,
}

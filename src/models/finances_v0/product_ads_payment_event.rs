...
pub struct ProductAdsPaymentEvent {
    ...
    pub base_value: Option<Box<models::finances_v0::Currency>>,
    #[serde(rename = "taxValue", skip_serializing_if = "Option::is_none")]
    pub tax_value: Option<Box<models::finances_v0::Currency>>,
    #[serde(rename = "transactionValue", skip_serializing_if = "Option::is_none")]
    pub transaction_value: Option<Box<models::finances_v0::Currency>>,
}

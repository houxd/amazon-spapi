...
pub struct ServiceJob {
    ...
    pub scope_of_work: Option<Box<models::services::ScopeOfWork>>,
    #[serde(rename = "seller", skip_serializing_if = "Option::is_none")]
    pub seller: Option<Box<models::services::Seller>>,
    #[serde(rename = "serviceJobProvider", skip_serializing_if = "Option::is_none")]
    pub service_job_provider: Option<Box<models::services::ServiceJobProvider>>,
    /// A list of appointment windows preferred by the buyer. Included only if the buyer selected appointment windows when creating the order.
    #[serde(rename = "preferredAppointmentTimes", skip_serializing_if = "Option::is_none")]
    pub preferred_appointment_times: Option<Vec<models::services::AppointmentTime>>,
    /// A list of appointments.
    #[serde(rename = "appointments", skip_serializing_if = "Option::is_none")]
    pub appointments: Option<Vec<models::services::Appointment>>,
    ...
    pub buyer: Option<Box<models::services::Buyer>>,
    /// A list of items associated with the service job.
    #[serde(rename = "associatedItems", skip_serializing_if = "Option::is_none")]
    pub associated_items: Option<Vec<models::services::AssociatedItem>>,
    #[serde(rename = "serviceLocation", skip_serializing_if = "Option::is_none")]
    pub service_location: Option<Box<models::services::ServiceLocation>>,
}

...
pub struct UpdateShipmentTrackingDetailsResponse {
    /// UUID for the given operation.
    #[serde(rename = "operationId")]
    pub operation_id: String,
}

impl UpdateShipmentTrackingDetailsResponse {
    /// The `updateShipmentTrackingDetails` response.
    pub fn new(operation_id: String) -> UpdateShipmentTrackingDetailsResponse {

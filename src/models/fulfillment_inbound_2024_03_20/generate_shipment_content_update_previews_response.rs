...
pub struct GenerateShipmentContentUpdatePreviewsResponse {
    /// UUID for the given operation.
    #[serde(rename = "operationId")]
    pub operation_id: String,
}

impl GenerateShipmentContentUpdatePreviewsResponse {
    /// The `GenerateShipmentContentUpdatePreviews` response.
    pub fn new(operation_id: String) -> GenerateShipmentContentUpdatePreviewsResponse {

...
pub struct GenerateTransportationOptionsResponse {
    /// UUID for the given operation.
    #[serde(rename = "operationId")]
    pub operation_id: String,
}

impl GenerateTransportationOptionsResponse {
    /// The `generateTransportationOptions` response.
    pub fn new(operation_id: String) -> GenerateTransportationOptionsResponse {

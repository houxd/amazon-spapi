...
pub struct ConfirmShipmentContentUpdatePreviewResponse {
    /// UUID for the given operation.
    #[serde(rename = "operationId")]
    pub operation_id: String,
}

impl ConfirmShipmentContentUpdatePreviewResponse {
    /// The `confirmShipmentContentUpdatePreview` response.
    pub fn new(operation_id: String) -> ConfirmShipmentContentUpdatePreviewResponse {

...
pub struct GenerateSelfShipAppointmentSlotsResponse {
    /// UUID for the given operation.
    #[serde(rename = "operationId")]
    pub operation_id: String,
}

impl GenerateSelfShipAppointmentSlotsResponse {
    /// The `generateSelfShipAppointmentSlots` response.
    pub fn new(operation_id: String) -> GenerateSelfShipAppointmentSlotsResponse {

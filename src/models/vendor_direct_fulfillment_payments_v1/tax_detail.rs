...
pub struct TaxDetail {
    ...
    pub tax_amount: Box<models::vendor_direct_fulfillment_payments_v1::Money>,
    #[serde(rename = "taxableAmount", skip_serializing_if = "Option::is_none")]
    pub taxable_amount: Option<Box<models::vendor_direct_fulfillment_payments_v1::Money>>,
}

impl TaxDetail {
    /// Details of tax amount applied.
    pub fn new(tax_type: TaxType, tax_amount: models::vendor_direct_fulfillment_payments_v1::Money) -> TaxDetail {
        TaxDetail {
            tax_type,
            tax_rate: None,

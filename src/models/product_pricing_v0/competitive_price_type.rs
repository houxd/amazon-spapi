...
pub struct CompetitivePriceType {
    ...
    #[serde(rename = "Price")]
    pub price: Box<models::product_pricing_v0::PriceType>,
...
impl CompetitivePriceType {
    ...
    pub fn new(competitive_price_id: String, price: models::product_pricing_v0::PriceType) -> CompetitivePriceType {

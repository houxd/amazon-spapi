...
impl ListingOffersRequest {
    ...
    pub fn new(uri: String, method: models::product_pricing_v0::HttpMethod, marketplace_id: String, item_condition: models::product_pricing_v0::ItemCondition) -> ListingOffersRequest {

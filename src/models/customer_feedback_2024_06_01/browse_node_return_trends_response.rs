...
pub struct BrowseNodeReturnTrendsResponse {
    ...
    #[serde(rename = "returnTrends")]
    pub return_trends: Vec<models::customer_feedback_2024_06_01::BrowseNodeReturnTrend>,
}

impl BrowseNodeReturnTrendsResponse {
    /// The response for the `getBrowseNodeReturnTrends` operation.
    pub fn new(browse_node_id: String, display_name: String, marketplace_id: String, country_code: String, date_range: models::customer_feedback_2024_06_01::DateRange, return_trends: Vec<models::customer_feedback_2024_06_01::BrowseNodeReturnTrend>) -> BrowseNodeReturnTrendsResponse {

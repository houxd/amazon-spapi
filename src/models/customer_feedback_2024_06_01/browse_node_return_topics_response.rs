...
pub struct BrowseNodeReturnTopicsResponse {
    ...
    #[serde(rename = "topics")]
    pub topics: Vec<models::customer_feedback_2024_06_01::BrowseNodeReturnTopics>,
}

impl BrowseNodeReturnTopicsResponse {
    /// The response for the `getBrowseNodeReturnTopics` operation.
    pub fn new(browse_node_id: String, display_name: String, marketplace_id: String, country_code: String, date_range: models::customer_feedback_2024_06_01::DateRange, topics: Vec<models::customer_feedback_2024_06_01::BrowseNodeReturnTopics>) -> BrowseNodeReturnTopicsResponse {

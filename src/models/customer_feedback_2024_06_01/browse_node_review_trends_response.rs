...
pub struct BrowseNodeReviewTrendsResponse {
    ...
    pub review_trends: Box<models::customer_feedback_2024_06_01::BrowseNodeReviewTrends>,
}

impl BrowseNodeReviewTrendsResponse {
    /// The response for the `getBrowseNodeReviewTrends` operation.
    pub fn new(browse_node_id: String, display_name: String, marketplace_id: String, country_code: String, date_range: models::customer_feedback_2024_06_01::DateRange, review_trends: models::customer_feedback_2024_06_01::BrowseNodeReviewTrends) -> BrowseNodeReviewTrendsResponse {

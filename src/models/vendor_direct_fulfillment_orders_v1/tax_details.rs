...
pub struct TaxDetails {
    ...
    pub tax_amount: Box<models::vendor_direct_fulfillment_orders_v1::Money>,
    #[serde(rename = "taxableAmount", skip_serializing_if = "Option::is_none")]
    pub taxable_amount: Option<Box<models::vendor_direct_fulfillment_orders_v1::Money>>,
    /// Tax type.
...
impl TaxDetails {
    ...
    pub fn new(tax_amount: models::vendor_direct_fulfillment_orders_v1::Money) -> TaxDetails {
        TaxDetails {
            tax_rate: None,

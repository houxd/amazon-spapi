...
pub struct PartyIdentification {
    ...
    pub address: Option<Box<models::vendor_direct_fulfillment_orders_v1::Address>>,
    #[serde(rename = "taxInfo", skip_serializing_if = "Option::is_none")]
    pub tax_info: Option<Box<models::vendor_direct_fulfillment_orders_v1::TaxRegistrationDetails>>,
}

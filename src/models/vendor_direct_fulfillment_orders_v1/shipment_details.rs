...
pub struct ShipmentDetails {
    ...
    pub shipment_dates: Box<models::vendor_direct_fulfillment_orders_v1::ShipmentDates>,
...
impl ShipmentDetails {
    ...
    pub fn new(is_priority_shipment: bool, is_pslip_required: bool, ship_method: String, shipment_dates: models::vendor_direct_fulfillment_orders_v1::ShipmentDates, message_to_customer: String) -> ShipmentDetails {
        ShipmentDetails {

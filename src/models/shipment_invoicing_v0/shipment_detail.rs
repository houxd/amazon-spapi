...
pub struct ShipmentDetail {
    ...
    pub shipping_address: Option<Box<models::shipment_invoicing_v0::Address>>,
    ...
    pub buyer_tax_info: Option<Box<models::shipment_invoicing_v0::BuyerTaxInfo>>,
    #[serde(rename = "MarketplaceTaxInfo", skip_serializing_if = "Option::is_none")]
    pub marketplace_tax_info: Option<Box<models::shipment_invoicing_v0::MarketplaceTaxInfo>>,
    ...
    pub shipment_items: Option<Vec<models::shipment_invoicing_v0::ShipmentItem>>,
}

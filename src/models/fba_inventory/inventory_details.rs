...
pub struct InventoryDetails {
    ...
    pub reserved_quantity: Option<Box<models::fba_inventory::ReservedQuantity>>,
    #[serde(rename = "researchingQuantity", skip_serializing_if = "Option::is_none")]
    pub researching_quantity: Option<Box<models::fba_inventory::ResearchingQuantity>>,
    #[serde(rename = "unfulfillableQuantity", skip_serializing_if = "Option::is_none")]
    pub unfulfillable_quantity: Option<Box<models::fba_inventory::UnfulfillableQuantity>>,
}

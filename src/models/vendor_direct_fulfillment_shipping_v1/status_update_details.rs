...
pub struct StatusUpdateDetails {
    ...
    pub status_location_address: Box<models::vendor_direct_fulfillment_shipping_v1::Address>,
    #[serde(rename = "shipmentSchedule", skip_serializing_if = "Option::is_none")]
    pub shipment_schedule: Option<Box<models::vendor_direct_fulfillment_shipping_v1::StatusUpdateDetailsShipmentSchedule>>,
}

impl StatusUpdateDetails {
    /// Details for the shipment status update given by the vendor for the specific package.
    pub fn new(tracking_number: String, status_code: String, reason_code: String, status_date_time: String, status_location_address: models::vendor_direct_fulfillment_shipping_v1::Address) -> StatusUpdateDetails {
        StatusUpdateDetails {
            tracking_number,
            status_code,
            reason_code,

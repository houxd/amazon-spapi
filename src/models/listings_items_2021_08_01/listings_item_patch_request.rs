...
pub struct ListingsItemPatchRequest {
    ...
    pub patches: Vec<models::listings_items_2021_08_01::PatchOperation>,
}

impl ListingsItemPatchRequest {
    /// The request body schema for the `patchListingsItem` operation.
    pub fn new(product_type: String, patches: Vec<models::listings_items_2021_08_01::PatchOperation>) -> ListingsItemPatchRequest {

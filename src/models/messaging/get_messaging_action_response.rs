...
pub struct GetMessagingActionResponse {
    ...
    pub _links: Option<Box<models::messaging::GetMessagingActionResponseLinks>>,
    #[serde(rename = "_embedded", skip_serializing_if = "Option::is_none")]
    pub _embedded: Option<Box<models::messaging::GetMessagingActionResponseEmbedded>>,
    #[serde(rename = "payload", skip_serializing_if = "Option::is_none")]
    pub payload: Option<Box<models::messaging::MessagingAction>>,

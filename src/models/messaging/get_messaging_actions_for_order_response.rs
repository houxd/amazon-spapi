...
pub struct GetMessagingActionsForOrderResponse {
    ...
    pub _links: Option<Box<models::messaging::GetMessagingActionsForOrderResponseLinks>>,
    #[serde(rename = "_embedded", skip_serializing_if = "Option::is_none")]
    pub _embedded: Option<Box<models::messaging::GetMessagingActionsForOrderResponseEmbedded>>,

...
> models::Package create_scheduled_package(create_scheduled_package_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**create_scheduled_package_request** | [**CreateScheduledPackageRequest**](CreateScheduledPackageRequest.md) | The request schema for the `createScheduledPackage` operation. | [required] |
...
> models::CreateScheduledPackagesResponse create_scheduled_package_bulk(create_scheduled_packages_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**create_scheduled_packages_request** | [**CreateScheduledPackagesRequest**](CreateScheduledPackagesRequest.md) | The request schema for the `createScheduledPackageBulk` operation. | [required] |

### Return type

[**models::CreateScheduledPackagesResponse**](CreateScheduledPackagesResponse.md)
...
> models::Package get_scheduled_package(amazon_order_id, marketplace_id)
...
> models::ListHandoverSlotsResponse list_handover_slots(list_handover_slots_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**list_handover_slots_request** | Option<[**ListHandoverSlotsRequest**](ListHandoverSlotsRequest.md)> | The request schema for the `listHandoverSlots` operation. |  |

### Return type

[**models::ListHandoverSlotsResponse**](ListHandoverSlotsResponse.md)
...
> models::Packages update_scheduled_packages(update_scheduled_packages_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**update_scheduled_packages_request** | Option<[**UpdateScheduledPackagesRequest**](UpdateScheduledPackagesRequest.md)> | The request schema for the `updateScheduledPackages` operation. |  |

### Return type

[**models::Packages**](Packages.md)

...
> models::Order get_order(purchase_order_number)
...
> models::OrderList get_orders(created_after, created_before, ship_from_party_id, status, limit, sort_order, next_token, include_details)
...
> models::TransactionId submit_acknowledgement(body)
...
[**models::TransactionId**](TransactionId.md)
